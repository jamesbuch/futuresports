        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              Contact FutureSports at office@futuresports.com.au or by using the
          ...
          >
            <div className="accordion-body">
              <p>
                ...
                &quot;yours&quot; or similar expressions shall mean any user of
                this website and the app whatsoever. Terms such as
                &quot;we&quot;, &quot;us, &quot;our&quot; or similar expressions
                shall mean FutureSports.
              </p>
              <p>
                This website, www.futuresports.com.au (the &quot;Website&quot;),
                and the FutureSports mobile application (the &quot;App&quot;)
                are operated by the FutureSports, a company registered in
                Australia under company number 123456789 with registered office
                at Main Street, Sydney, NSW 2000. Our ACN is 012 345 678 901.
              </p>
              <p>
              ...
              <p>
                ...
                to the Website, or close it indefinitely. We will not be liable
                if for any reason the Website is unavailable at any time or for
                any period. Any of the material on the Website may be out of
              ...
              <p>
                ...
                intellectual property and related rights (&quot;Rights&quot;)
              ...
              <blockquote>
                ...
                forward such material from the Website to other people for their
                private and personal use provided you credit us as its source
                and add the Website address: www.futuresports.com.au. You must
                draw their attention to these terms which also apply to them;
                and You may provide links to the Website provided they go to the
                home page only and provided you do so in a way that is fair,
                legal and does not damage our reputation or take advantage of
                it. You must not establish a link in such a way as to suggest
                any form of association, approval or endorsement on the part of
                us where none exists.
              </blockquote>
              <p>
                ...
                material downloaded or otherwise obtained from the Website), or
                frame or deep-link to it (or to any of its content) on any other
                website, without our prior written approval. If you print off,
                copy or download any part of the Website in breach of these
                terms, your right to use the Website will cease immediately and
                you must return or destroy any copies of the materials you have
                made at our request.
              </p>
              <p>
                The trade marks, logos and brand names shown on the Website are
                owned by us or our suppliers, partners or member Clubs. No
                rights are granted to use any of them without the prior written
                permission of the owner.
              </p>
              <p>
                Reasonable skill and care has been used in producing the Website
                but it is only designed for general information purposes. No
                guarantee is given by us or our suppliers that the Website
                (including any statistics contained on the Website) is accurate,
                complete or up-to-date. We therefore disclaim all liability and
                responsibility arising from any reliance placed on the content
                of the Website by you, or by anyone who may be informed of the
                Website&aops;s contents.
              </p>
              <p>
                The Website contains links to other websites and services
                operated by parties independent to the us. We take reasonable
                precautions in selecting these however we do not endorse or take
                responsibility for the content or availability of these websites
                and cannot accept any liability for any material contained
                within them or for your use of them or any use of your personal
                data collected by their operators. If you decide to access
                linked websites you do so at your own risk and we encourage you
                to read the privacy statements applicable to each specific
                website.
              </p>
              <p>
                We and our suppliers take reasonable precautions to prevent
                computer viruses, trojan horses, worms, time bombs, cancelbots,
                corrupted files, or any other items that may damage the
                operation of computers or property or otherwise engage in
                computer misuse (&quot;Malicious Programmes&quot;) on the
                Website but cannot accept any liability for them. You are
                advised to take precautions against such Malicious Programmes,
                including the use of suitable protective software.
              </p>
              <p>
                You must not misuse the Website by knowingly introducing
                Malicious Programmes. You must not attempt to gain unauthorised
                access to the Website, the server on which the Website is stored
                ...
                or a distributed denial-of-service attack. By breaching this
                provision, you would commit a criminal offence under Australian
                law. We will report any such breach to the relevant law
                enforcement authorities and will co-operate with those
                authorities by disclosing your identity to them. In the event of
                such a breach, your right to use the Website will cease
                immediately.
              </p>
              <p>
                Except in the case of death or personal injury caused by our
                negligence or any wilful act, to the fullest extent permitted by
                law we exclude all liability to you in respect of your Account
                and your use of the Website and App.
              </p>
              <p>
                These Terms of Use are governed by and interpreted in accordance
                with the laws of Australia. Any disputes arising under or in
                connection with these terms shall be subject to the
                non-exclusive jurisdiction of the Australian courts.
              </p>
              <p>
